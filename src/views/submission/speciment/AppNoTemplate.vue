  ...
  <div>
    ...
    <a-descriptions title="打包运送">
      <a-descriptions-item label="打包号">
        {{ this.initializeData(this.record.sendPackages, 'SendNo') }}
      </a-descriptions-item>
      <a-descriptions-item label="打包编号">
        {{ this.initializeData(this.record.sendPackages, 'Id') }}
      </a-descriptions-item>
      <a-descriptions-item label="打包时间">
        {{ this.initializeData(this.record.sendPackages, 'CreatedTime') }}
      </a-descriptions-item>
      <a-descriptions-item label="打包人">
        {{ this.initializeData(this.record.sendPackages, 'Submitter') }}
      </a-descriptions-item>
      <a-descriptions-item label="运送时间">
        {{ this.initializeData(this.record.sendPackages, 'ShippingStartTime') }}
      </a-descriptions-item>
      <a-descriptions-item label="发送人">
        {{ this.initializeData(this.record.sendPackages, 'Shipper') }}
      </a-descriptions-item>
      <a-descriptions-item label="接收时间">
        {{ this.initializeData(this.record.sendPackages, 'ShippingEndTime') }}
      </a-descriptions-item>
    </a-descriptions>
  </div>
</template>
