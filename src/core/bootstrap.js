...
export default function Initializer () {
  getJson(`${process.env.BASE_URL}urls.json`).then(res => {
    // sessionStorage['baseURL'] = res.data.apiBaseUrl
    storage.set('baseURL', res.data.apiBaseUrl)
    storage.set('CASrc', res.data.CASrc)
  })
